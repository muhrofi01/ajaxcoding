                ...
                <div class="flex items-center px-4">
                    ...
                    <ul class="block w-[400px] lg:flex justify-between">
                        <li class="flex px-3 group">
                            <a href="#home" class="py-2 text-base font-medium text-slate-100 group-hover:font-bold nav-item">Home</a>
                        </li>
                        <li class="flex px-3 group">
                            <a href="#about" class="py-2 text-base font-medium text-slate-100 group-hover:font-bold nav-item">About</a>
                        </li>
                        <li class="flex px-3 group">
                            <a href="#product" class="py-2 text-base font-medium text-slate-100 group-hover:font-bold nav-item">Product</a>
                        </li>
                        <li class="flex px-3 group">
                            <a href="#portfolio" class="py-2 text-base font-medium text-slate-100 group-hover:font-bold nav-item">Portfolio</a>
                        </li>
                        <li class="flex px-3 group">
                            <a href="#contact" class="py-2 text-base font-medium text-slate-100 group-hover:font-bold nav-item">Contact</a>
                        </li>
                    </ul>
                </nav>
                </div>
    ...
    <section id="about" class="py-24">
        ...
        <div class="justify-around w-full px-6 m-auto mt-9 md:flex md:w-4/5 text-slate-900">
            <div class="px-4 mt-5 md:w-1/2">
                ...
                <p class="mt-2 text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis porro deserunt cumque, asperiores corrupti aperiam cupiditate blanditiis voluptate ipsam, hic doloremque veritatis vero omnis at aspernatur quia neque eius ipsa.</p>
            </div>
            <div class="px-4 mt-5 md:w-1/2">
                <h4 class="text-2xl font-semibold">Mari menyewa jasa kami</h4>
                <p class="mt-2 text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus animi laboriosam corrupti esse quia perspiciatis natus quasi molestiae quos quo.</p>
    ...
    <section id="product" class="py-24">
        ...
        <div class="w-full px-6 m-auto mt-9">
           <div class="grid grid-cols-1 gap-2 m-auto sm:w-[600px] sm:grid-cols-3 md:w-[700px]">
                <div class="w-full py-2 font-semibold text-center rounded-full bg-grayAjax hover:bg-yellowAjax">Invitation</div>
                <div class="w-full py-2 font-semibold text-center rounded-full bg-grayAjax hover:bg-yellowAjax">Online Shop</div>
                <div class="w-full py-2 font-semibold text-center rounded-full bg-grayAjax hover:bg-yellowAjax">Company Profile</div>
           </div>
        </div>
        ...
        <div class="w-[850px] m-auto mt-9 flex justify-evenly items-center relative">
            <div class="w-[350px] h-[200px] bg-slate-400 rounded-2xl group">
                <div class="w-[350px] h-16 hidden bg-sky-500 absolute z-10 top-1/2 -translate-y-1/2 opacity-90 group-hover:block">
                    <h1 class="absolute w-full text-3xl font-bold text-center -translate-y-1/2 text-slate-100 top-1/2">Ini Portfolio Pertama</h1>
                </div>
            </div>
            <div class="w-[350px] h-[200px] bg-slate-400 rounded-2xl group">
                <div class="w-[350px] h-16 hidden bg-sky-500 absolute z-10 top-1/2 -translate-y-1/2 opacity-90 group-hover:block">
            ...
            <div class="w-full mt-9 m-auto bg-blueformAjax rounded-2xl sm:w-[500px] md:w-[700px]">
                <form action="" class="p-5 ">
                    ...
                    <div class="my-3">
                        <label for="" class="text-slate-100">
                            Pesan
                            <textarea name="pesan" id="pesan" class="w-full rounded-md" rows="5" placeholder="Pesan"></textarea>
                        </label>
                    </div>
                    <div class="my-3">
                        <input type="submit" class="w-full py-2 rounded-full bg-grayAjax hover:bg-yellowAjax hover:cursor-pointer" value="Submit">
                    </div>
                </form>
            </div>
        </div>
